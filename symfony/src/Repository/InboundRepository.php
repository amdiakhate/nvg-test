 ...
 */
class InboundRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return Inbound[] Returns an array of Inbound objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Inbound
    {
        return $this->createQueryBuilder('i')
            ->andWhere('i.exampleField = :val')
            ->setParameter('val', $value)
